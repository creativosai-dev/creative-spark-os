      ...
      <div className="section-container">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-3 mb-4">
              ...
              />
              <span className="font-bold text-2xl">CreativOS</span>
            </div>
            <p className="text-background/70 max-w-sm leading-relaxed mb-6">
              The AI-powered UGC Ads Engine for performance marketers. 
              Generate scroll-stopping ad videos from your brand assets in minutes.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-background/70">
              ...
              <li><a href="mailto:hello@creativos.ai" className="hover:text-background transition-colors">Contact</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-background/10 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-background/50">
            © {currentYear} CreativOS. All rights reserved.
          </p>
